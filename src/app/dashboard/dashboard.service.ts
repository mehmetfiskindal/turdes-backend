...
export class DashboardService {
  ...
  async getAidDistributionStats() {
    try {
      ...
      throw new InternalServerErrorException(
        `Yardım dağıtım istatistikleri alınırken bir hata oluştu: ${error.message}`,
      );
    }
  }
  ...
  async getUserCategoryStats() {
    try {
      ...
      throw new InternalServerErrorException(
        `Kullanıcı kategorileri istatistikleri alınırken bir hata oluştu: ${error.message}`,
      );
    }
  }
  ...
  async getOrganizationStats() {
    try {
      ...
      throw new InternalServerErrorException(
        `Organizasyon istatistikleri alınırken bir hata oluştu: ${error.message}`,
      );
    }
  }
  ...
  async getDonationStats() {
    try {
      ...
      throw new InternalServerErrorException(
        `Bağış istatistikleri alınırken bir hata oluştu: ${error.message}`,
      );
    }
  }
  ...
  async getAidEfficiencyByLocation() {
    try {
      ...
      throw new InternalServerErrorException(
        `Konum bazlı yardım verimliliği istatistikleri alınırken bir hata oluştu: ${error.message}`,
      );
    }
  }
  ...
  async getComprehensiveAnalytics() {
    try {
      ...
      throw new InternalServerErrorException(
        `Kapsamlı analizler alınırken bir hata oluştu: ${error.message}`,
      );
    }
  }
